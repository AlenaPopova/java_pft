...
public class JamesHelper {
    ...
    public void deleteUser(String name) { // метод для  удаления пользователя
        initTelnetSession();
        write("deluser " + name);
    ...
    private void initTelnetSession() {
        ...
        try {
            ...
            in = telnet.getInputStream(); // входной поток - чтобы что-то читать, те данные,которые telnet отправляет нам
            out = new PrintStream( telnet.getOutputStream() ); // выходной поток - чтобы что-то писать и отправлять команды
